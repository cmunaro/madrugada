...
class PatternMatchFullStateChange<S: MadrugadaState>(override val matchersPartialState: ArrayList<Matcher<S>>) :
    PatternMatchFullStateChangeInterface<S> {
    override fun patternMatchFullStateChange(vararg properties: KProperty1<S, *>, action: (S) -> Unit) {
